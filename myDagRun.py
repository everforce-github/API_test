...
class DagRun(Base, LoggingMixin):
    ...
    task_instances = relationship(
        ...
        backref=backref('dag_run2', uselist=False),
...
#myDagRun = DagRun ('dag_1', 'dagrun_1', func.now(), 'running', True, False, 'manual', 0, func.now(), func.now() )
print ("UTC Date time now:", timezone.utcnow())
myDagRun = DagRun ('dag_1', 'dagrun_1', timezone.utcnow(), timezone.utcnow(), True, '', 'running', 'manual', '', '' )

print("DagRun id " + myDagRun.run_id + " created")
#dg = myDagRun.get_dag()
